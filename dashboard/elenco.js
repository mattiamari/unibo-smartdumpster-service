// url di mari nel quale si trovano i dati
// http://mattiamari.me:8069/api/v1/dumpster/id-del-dumpster
var apiUrl = 'http://mattiamari.me:8069/api/v1/dumpsters';
...
$.getJSON(apiUrl, function(data) {
    ...
    document.querySelector('.button').addEventListener("click", function() {
        ...
        idDumpster = this.parentNode.parentNode.querySelector('.idDumpster').innerHTML;
        ...
        $.ajax({
            type: "POST",
            url: "http://mattiamari.me:8069/api/v1/dumpster/" + idDumpster + "/availability",
